...
#SBATCH --job-name=MC_PA_TSDE_Cutadapt_Round2	# Replace with your jobname
...
#### Start Script
run_cmd "srun $PYTHON $CUTADAPT -G G{20} -e 0.0 -n 10 --minimum-length 25 --cores $SLURM_CPUS_PER_TASK \
-o ${SAMPLE_PREFIX}_R1_TrimmingRound2.fastq.gz -p ${SAMPLE_PREFIX}_R2_TrimmingRound2.fastq.gz \
${SAMPLE_PREFIX}_R1_TrimmingRound1.fastq.gz ${SAMPLE_PREFIX}_R2_TrimmingRound1.fastq.gz > ${SAMPLE_PREFIX}.cutadapt_round2.log 2>&1"
