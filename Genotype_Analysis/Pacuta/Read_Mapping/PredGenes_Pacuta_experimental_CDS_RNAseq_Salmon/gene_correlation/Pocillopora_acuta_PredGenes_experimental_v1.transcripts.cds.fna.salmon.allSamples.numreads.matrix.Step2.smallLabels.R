...
pdf("Pocillopora_acuta_PredGenes_experimental_v1.transcripts.cds.fna.salmon.allSamples.numreads.matrix.minRow10.CPM.log2.sample_cor_matrix.smallLabels.pdf")
