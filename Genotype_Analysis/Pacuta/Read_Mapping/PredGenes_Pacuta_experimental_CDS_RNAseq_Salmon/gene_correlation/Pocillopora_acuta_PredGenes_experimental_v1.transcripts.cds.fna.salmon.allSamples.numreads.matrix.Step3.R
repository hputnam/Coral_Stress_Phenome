...
write.table(data, file="Pocillopora_acuta_PredGenes_experimental_v1.transcripts.cds.fna.salmon.allSamples.numreads.matrix.minRow10.CPM.log2.centered.dat", quote=F, sep='	');
pdf("Pocillopora_acuta_PredGenes_experimental_v1.transcripts.cds.fna.salmon.allSamples.numreads.matrix.minRow10.CPM.log2.centered.prcomp.principal_components.pdf")
prin_comp_data = data
...
write.table(pca$rotation, file="Pocillopora_acuta_PredGenes_experimental_v1.transcripts.cds.fna.salmon.allSamples.numreads.matrix.minRow10.CPM.log2.centered.PCA.prcomp.scores", quote=F, sep="	")
write.table(pca$x, file="Pocillopora_acuta_PredGenes_experimental_v1.transcripts.cds.fna.salmon.allSamples.numreads.matrix.minRow10.CPM.log2.centered.PCA.prcomp.loadings", quote=F, sep="	")
PCA.loadings=pca$x
