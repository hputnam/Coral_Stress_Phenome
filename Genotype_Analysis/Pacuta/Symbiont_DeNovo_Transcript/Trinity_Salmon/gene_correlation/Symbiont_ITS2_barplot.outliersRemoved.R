...
ITS2.matrix.file <- "ITS2_Profiles_with_original_SampleIDs.Pacuta.outliersRemoved.txt"
sample.order.file <- "Trinity.fasta.salmon.allSamples.numreads.matrix.hclust_sample_order.outliersRemoved.txt"
output.file <- "ITS2_Profiles_with_original_SampleIDs.Pacuta.outliersRemoved.txt.barplot_ordered_samples.pdf"
