...
#SBATCH --job-name=Salmon_index			# Replace with your jobname
...
#### Start Script
run_cmd "salmon index --transcripts $TRANSCRIPTS --index $INDEX --kmerLen $KMER --threads $SLURM_CPUS_PER_TASK"
