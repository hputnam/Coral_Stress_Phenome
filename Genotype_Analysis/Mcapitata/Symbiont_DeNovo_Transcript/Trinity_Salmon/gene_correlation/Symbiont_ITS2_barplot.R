...
ITS2.matrix.file <- "ITS2_Profiles_with_original_SampleIDs.Mcapitata.txt"
sample.order.file <- "Trinity.fasta.salmon.allSamples.numreads.matrix.hclust_sample_order.txt"
output.file <- "ITS2_Profiles_with_original_SampleIDs.Mcapitata.txt.barplot_ordered_samples.pdf"
