...
#write.table(data, file=paste(plot.prefix,".minRow10.CPM.log2.dat",sep=''), quote=F, sep='	');
if (nrow(data) < 2) { stop("
...
#write.table(sample_cor, file=paste(plot.prefix,".minRow10.CPM.log2.sample_cor.dat",sep=''), quote=F, sep='	')
sample_dist = dist(t(data), method='euclidean')
hc_samples = hclust(sample_dist, method='complete')
pdf(paste(plot.prefix,".minRow10.CPM.log2.sample_cor_matrix.pdf",sep=''))
