...
## Annotations
#awk -F'\t' '$7=="Pacuta" {print $2"\t"$4}' ../../../../../0009_Coral_Stress_Phenome/01_Data/Supplementary_Tables_S1-Samples.txt > annotations.SiteName.txt
...
cat annotations.SiteName.txt \
 ...
 | ./add_value_to_table.py -c 1 -a annotations.Ploidy.txt \
 | ./add_value_to_table.py -c 6 -a annotations.PloidyColors.txt \
 > annotations.txt
#    1           2          3         4         5          6         7
