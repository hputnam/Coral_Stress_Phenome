...
DESCRIPTION="
##
## Plot Genotype Quality (GQ) for variants from each sample. File to plot should have *.GT.GQ.txt extension (script will auto find these files).
##

# Example:
Rscript plot_GQ_scores.R out_prefix cutoff x-lim
